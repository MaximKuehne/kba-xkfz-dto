...
/**
 * This class stands for AutonomesFahren StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class AutonomesFahren extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for AutonomesFahren
     * @uses AutonomesFahren::setNummerBetriebserlaubnis()
     * @uses AutonomesFahren::setDatumBetriebserlaubnis()
     * @uses AutonomesFahren::setAusstellendeBehoerdeBetriebserlaubnis()
     * @uses AutonomesFahren::setNummerErprobungsgenehmigung()
     * @uses AutonomesFahren::setDatumErprobungsgenehmigung()
     * @uses AutonomesFahren::setAusstellendeBehoerdeErprobungsgenehmigung()
     * @uses AutonomesFahren::setNummerBetriebsbereichsgenehmigung()
     * @uses AutonomesFahren::setDatumBetriebsbereichsgenehmigung()
     * @uses AutonomesFahren::setAusstellendeBehoerdeBetriebsbereichsgenehmigung()
     * @uses AutonomesFahren::setAngabeAusruestung()
     ...
     * @param string $nummerBetriebserlaubnis
     * @return \THAG\XKfz\StructType\AutonomesFahren
     */
