...
/**
 * This class stands for BatchVeraeusserungsanzeigeTyp StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class BatchVeraeusserungsanzeigeTyp extends AbstractStructBase
{
    /**
     * The Person
    ...
    /**
     * Constructor method for BatchVeraeusserungsanzeigeTyp
     * @uses BatchVeraeusserungsanzeigeTyp::setPerson()
     * @uses BatchVeraeusserungsanzeigeTyp::setAnschrift()
     * @uses BatchVeraeusserungsanzeigeTyp::setTextErwerberdaten()
     ...
     * Set Person value
     * @param \THAG\XKfz\StructType\Person $person
     * @return \THAG\XKfz\StructType\BatchVeraeusserungsanzeigeTyp
     */
