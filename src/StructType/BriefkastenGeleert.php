...
/**
 * This class stands for BriefkastenGeleert StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class BriefkastenGeleert extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for BriefkastenGeleert
     * @uses BriefkastenGeleert::setListeNachrichtenId()
     ...
     * @param \THAG\XKfz\StructType\ListeNachrichtenId $listeNachrichtenId
     * @return \THAG\XKfz\StructType\BriefkastenGeleert
     */
