...
/**
 * This class stands for Code.ArtDerBremse StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDerBremse extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDerBremse
     * @uses Code_ArtDerBremse::setCode()
     * @uses Code_ArtDerBremse::setName()
     * @uses Code_ArtDerBremse::setListURI()
     * @uses Code_ArtDerBremse::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDerBremse
     */
