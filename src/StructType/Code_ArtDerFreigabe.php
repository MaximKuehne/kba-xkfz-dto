...
/**
 * This class stands for Code.ArtDerFreigabe StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDerFreigabe extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDerFreigabe
     * @uses Code_ArtDerFreigabe::setCode()
     * @uses Code_ArtDerFreigabe::setName()
     * @uses Code_ArtDerFreigabe::setListURI()
     * @uses Code_ArtDerFreigabe::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDerFreigabe
     */
