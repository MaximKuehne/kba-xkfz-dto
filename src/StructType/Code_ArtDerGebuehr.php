...
/**
 * This class stands for Code.ArtDerGebuehr StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDerGebuehr extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDerGebuehr
     * @uses Code_ArtDerGebuehr::setCode()
     * @uses Code_ArtDerGebuehr::setName()
     * @uses Code_ArtDerGebuehr::setListURI()
     * @uses Code_ArtDerGebuehr::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDerGebuehr
     */
