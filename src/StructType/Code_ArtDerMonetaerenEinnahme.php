...
/**
 * This class stands for Code.ArtDerMonetaerenEinnahme StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDerMonetaerenEinnahme extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDerMonetaerenEinnahme
     * @uses Code_ArtDerMonetaerenEinnahme::setCode()
     * @uses Code_ArtDerMonetaerenEinnahme::setName()
     * @uses Code_ArtDerMonetaerenEinnahme::setListURI()
     * @uses Code_ArtDerMonetaerenEinnahme::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDerMonetaerenEinnahme
     */
