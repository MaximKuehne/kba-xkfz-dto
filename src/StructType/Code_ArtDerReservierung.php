...
/**
 * This class stands for Code.ArtDerReservierung StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDerReservierung extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDerReservierung
     * @uses Code_ArtDerReservierung::setCode()
     * @uses Code_ArtDerReservierung::setName()
     * @uses Code_ArtDerReservierung::setListURI()
     * @uses Code_ArtDerReservierung::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDerReservierung
     */
