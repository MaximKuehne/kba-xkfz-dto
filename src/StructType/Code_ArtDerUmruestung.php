...
/**
 * This class stands for Code.ArtDerUmruestung StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDerUmruestung extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDerUmruestung
     * @uses Code_ArtDerUmruestung::setCode()
     * @uses Code_ArtDerUmruestung::setName()
     * @uses Code_ArtDerUmruestung::setListURI()
     * @uses Code_ArtDerUmruestung::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDerUmruestung
     */
