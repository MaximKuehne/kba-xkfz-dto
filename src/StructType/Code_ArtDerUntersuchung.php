...
/**
 * This class stands for Code.ArtDerUntersuchung StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDerUntersuchung extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDerUntersuchung
     * @uses Code_ArtDerUntersuchung::setCode()
     * @uses Code_ArtDerUntersuchung::setName()
     * @uses Code_ArtDerUntersuchung::setListURI()
     * @uses Code_ArtDerUntersuchung::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDerUntersuchung
     */
