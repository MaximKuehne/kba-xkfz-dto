...
/**
 * This class stands for Code.ArtDerUntersuchungsstelle StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDerUntersuchungsstelle extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDerUntersuchungsstelle
     * @uses Code_ArtDerUntersuchungsstelle::setCode()
     * @uses Code_ArtDerUntersuchungsstelle::setName()
     * @uses Code_ArtDerUntersuchungsstelle::setListURI()
     * @uses Code_ArtDerUntersuchungsstelle::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDerUntersuchungsstelle
     */
