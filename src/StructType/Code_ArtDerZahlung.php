...
/**
 * This class stands for Code.ArtDerZahlung StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDerZahlung extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDerZahlung
     * @uses Code_ArtDerZahlung::setCode()
     * @uses Code_ArtDerZahlung::setName()
     * @uses Code_ArtDerZahlung::setListURI()
     * @uses Code_ArtDerZahlung::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDerZahlung
     */
