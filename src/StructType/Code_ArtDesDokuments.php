...
/**
 * This class stands for Code.ArtDesDokuments StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDesDokuments extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDesDokuments
     * @uses Code_ArtDesDokuments::setCode()
     * @uses Code_ArtDesDokuments::setName()
     * @uses Code_ArtDesDokuments::setListURI()
     * @uses Code_ArtDesDokuments::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDesDokuments
     */
