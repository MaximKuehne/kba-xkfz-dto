...
/**
 * This class stands for Code.ArtDesGeschaeftsvorfalls StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDesGeschaeftsvorfalls extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDesGeschaeftsvorfalls
     * @uses Code_ArtDesGeschaeftsvorfalls::setCode()
     * @uses Code_ArtDesGeschaeftsvorfalls::setName()
     * @uses Code_ArtDesGeschaeftsvorfalls::setListURI()
     * @uses Code_ArtDesGeschaeftsvorfalls::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDesGeschaeftsvorfalls
     */
