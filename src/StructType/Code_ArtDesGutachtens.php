...
/**
 * This class stands for Code.ArtDesGutachtens StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDesGutachtens extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDesGutachtens
     * @uses Code_ArtDesGutachtens::setCode()
     * @uses Code_ArtDesGutachtens::setName()
     * @uses Code_ArtDesGutachtens::setListURI()
     * @uses Code_ArtDesGutachtens::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDesGutachtens
     */
