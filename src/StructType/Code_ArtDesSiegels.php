...
/**
 * This class stands for Code.ArtDesSiegels StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDesSiegels extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDesSiegels
     * @uses Code_ArtDesSiegels::setCode()
     * @uses Code_ArtDesSiegels::setName()
     * @uses Code_ArtDesSiegels::setListURI()
     * @uses Code_ArtDesSiegels::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDesSiegels
     */
