...
/**
 * This class stands for Code.ArtDesZertifikates StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ArtDesZertifikates extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ArtDesZertifikates
     * @uses Code_ArtDesZertifikates::setCode()
     * @uses Code_ArtDesZertifikates::setName()
     * @uses Code_ArtDesZertifikates::setListURI()
     * @uses Code_ArtDesZertifikates::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ArtDesZertifikates
     */
