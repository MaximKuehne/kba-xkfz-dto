...
/**
 * This class stands for Code.Auskunftsmedium StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Auskunftsmedium extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Auskunftsmedium
     * @uses Code_Auskunftsmedium::setCode()
     * @uses Code_Auskunftsmedium::setName()
     * @uses Code_Auskunftsmedium::setListURI()
     * @uses Code_Auskunftsmedium::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Auskunftsmedium
     */
