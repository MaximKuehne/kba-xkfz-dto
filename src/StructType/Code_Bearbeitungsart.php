...
/**
 * This class stands for Code.Bearbeitungsart StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Bearbeitungsart extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Bearbeitungsart
     * @uses Code_Bearbeitungsart::setCode()
     * @uses Code_Bearbeitungsart::setName()
     * @uses Code_Bearbeitungsart::setListURI()
     * @uses Code_Bearbeitungsart::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Bearbeitungsart
     */
