...
/**
 * This class stands for Code.BegruendungKeinOBFCM StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_BegruendungKeinOBFCM extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.BegruendungKeinOBFCM
     * @uses Code_BegruendungKeinOBFCM::setCode()
     * @uses Code_BegruendungKeinOBFCM::setName()
     * @uses Code_BegruendungKeinOBFCM::setListURI()
     * @uses Code_BegruendungKeinOBFCM::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_BegruendungKeinOBFCM
     */
