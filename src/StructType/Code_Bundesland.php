...
/**
 * This class stands for Code.Bundesland StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Bundesland extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Bundesland
     * @uses Code_Bundesland::setCode()
     * @uses Code_Bundesland::setName()
     * @uses Code_Bundesland::setListURI()
     * @uses Code_Bundesland::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Bundesland
     */
