...
/**
 * This class stands for Code.ErgebnisDerUntersuchung StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ErgebnisDerUntersuchung extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ErgebnisDerUntersuchung
     * @uses Code_ErgebnisDerUntersuchung::setCode()
     * @uses Code_ErgebnisDerUntersuchung::setName()
     * @uses Code_ErgebnisDerUntersuchung::setListURI()
     * @uses Code_ErgebnisDerUntersuchung::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ErgebnisDerUntersuchung
     */
