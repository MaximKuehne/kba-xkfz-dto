...
/**
 * This class stands for Code.GrundAblehnungZulassungsantrag StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_GrundAblehnungZulassungsantrag extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.GrundAblehnungZulassungsantrag
     * @uses Code_GrundAblehnungZulassungsantrag::setCode()
     * @uses Code_GrundAblehnungZulassungsantrag::setName()
     * @uses Code_GrundAblehnungZulassungsantrag::setListURI()
     * @uses Code_GrundAblehnungZulassungsantrag::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_GrundAblehnungZulassungsantrag
     */
