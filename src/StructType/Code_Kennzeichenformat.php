...
/**
 * This class stands for Code.Kennzeichenformat StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Kennzeichenformat extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Kennzeichenformat
     * @uses Code_Kennzeichenformat::setCode()
     * @uses Code_Kennzeichenformat::setName()
     * @uses Code_Kennzeichenformat::setListURI()
     * @uses Code_Kennzeichenformat::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Kennzeichenformat
     */
