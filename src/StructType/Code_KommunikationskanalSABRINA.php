...
/**
 * This class stands for Code.KommunikationskanalSABRINA StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_KommunikationskanalSABRINA extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.KommunikationskanalSABRINA
     * @uses Code_KommunikationskanalSABRINA::setCode()
     * @uses Code_KommunikationskanalSABRINA::setName()
     * @uses Code_KommunikationskanalSABRINA::setListURI()
     * @uses Code_KommunikationskanalSABRINA::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_KommunikationskanalSABRINA
     */
