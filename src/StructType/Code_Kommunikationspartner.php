...
/**
 * This class stands for Code.Kommunikationspartner StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Kommunikationspartner extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Kommunikationspartner
     * @uses Code_Kommunikationspartner::setCode()
     * @uses Code_Kommunikationspartner::setName()
     * @uses Code_Kommunikationspartner::setListURI()
     * @uses Code_Kommunikationspartner::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Kommunikationspartner
     */
