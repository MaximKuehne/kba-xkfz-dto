...
/**
 * This class stands for Code.KommunikationsschrittSABRINA StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_KommunikationsschrittSABRINA extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.KommunikationsschrittSABRINA
     * @uses Code_KommunikationsschrittSABRINA::setCode()
     * @uses Code_KommunikationsschrittSABRINA::setName()
     * @uses Code_KommunikationsschrittSABRINA::setListURI()
     * @uses Code_KommunikationsschrittSABRINA::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_KommunikationsschrittSABRINA
     */
