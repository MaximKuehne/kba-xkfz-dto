...
/**
 * This class stands for Code.Lieferdienst StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Lieferdienst extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Lieferdienst
     * @uses Code_Lieferdienst::setCode()
     * @uses Code_Lieferdienst::setName()
     * @uses Code_Lieferdienst::setListURI()
     * @uses Code_Lieferdienst::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Lieferdienst
     */
