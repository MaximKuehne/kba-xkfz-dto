...
/**
 * This class stands for Code.Nachrichtentyp StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Nachrichtentyp extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Nachrichtentyp
     * @uses Code_Nachrichtentyp::setCode()
     * @uses Code_Nachrichtentyp::setName()
     * @uses Code_Nachrichtentyp::setListURI()
     * @uses Code_Nachrichtentyp::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Nachrichtentyp
     */
