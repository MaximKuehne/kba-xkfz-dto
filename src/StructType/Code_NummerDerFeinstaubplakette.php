...
/**
 * This class stands for Code.NummerDerFeinstaubplakette StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_NummerDerFeinstaubplakette extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.NummerDerFeinstaubplakette
     * @uses Code_NummerDerFeinstaubplakette::setCode()
     * @uses Code_NummerDerFeinstaubplakette::setName()
     * @uses Code_NummerDerFeinstaubplakette::setListURI()
     * @uses Code_NummerDerFeinstaubplakette::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_NummerDerFeinstaubplakette
     */
