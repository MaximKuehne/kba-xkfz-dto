...
/**
 * This class stands for Code.NutzungBankverbindung StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_NutzungBankverbindung extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.NutzungBankverbindung
     * @uses Code_NutzungBankverbindung::setCode()
     * @uses Code_NutzungBankverbindung::setName()
     * @uses Code_NutzungBankverbindung::setListURI()
     * @uses Code_NutzungBankverbindung::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_NutzungBankverbindung
     */
