...
/**
 * This class stands for Code.PositionDerBremse StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_PositionDerBremse extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.PositionDerBremse
     * @uses Code_PositionDerBremse::setCode()
     * @uses Code_PositionDerBremse::setName()
     * @uses Code_PositionDerBremse::setListURI()
     * @uses Code_PositionDerBremse::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_PositionDerBremse
     */
