...
/**
 * This class stands for Code.ProzessschrittName StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_ProzessschrittName extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.ProzessschrittName
     * @uses Code_ProzessschrittName::setCode()
     * @uses Code_ProzessschrittName::setName()
     * @uses Code_ProzessschrittName::setListURI()
     * @uses Code_ProzessschrittName::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_ProzessschrittName
     */
