...
/**
 * This class stands for Code.Prueforganisation StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Prueforganisation extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Prueforganisation
     * @uses Code_Prueforganisation::setCode()
     * @uses Code_Prueforganisation::setName()
     * @uses Code_Prueforganisation::setListURI()
     * @uses Code_Prueforganisation::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Prueforganisation
     */
