...
/**
 * This class stands for Code.Quittungsart StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Quittungsart extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Quittungsart
     * @uses Code_Quittungsart::setCode()
     * @uses Code_Quittungsart::setName()
     * @uses Code_Quittungsart::setListURI()
     * @uses Code_Quittungsart::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Quittungsart
     */
