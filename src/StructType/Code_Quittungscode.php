...
/**
 * This class stands for Code.Quittungscode StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Quittungscode extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Quittungscode
     * @uses Code_Quittungscode::setCode()
     * @uses Code_Quittungscode::setName()
     * @uses Code_Quittungscode::setListURI()
     * @uses Code_Quittungscode::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Quittungscode
     */
