...
/**
 * This class stands for Code.Quittungsebene StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Quittungsebene extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Quittungsebene
     * @uses Code_Quittungsebene::setCode()
     * @uses Code_Quittungsebene::setName()
     * @uses Code_Quittungsebene::setListURI()
     * @uses Code_Quittungsebene::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Quittungsebene
     */
