...
/**
 * This class stands for Code.RechtsgrundlageHalterauskunft StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_RechtsgrundlageHalterauskunft extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.RechtsgrundlageHalterauskunft
     * @uses Code_RechtsgrundlageHalterauskunft::setCode()
     * @uses Code_RechtsgrundlageHalterauskunft::setName()
     * @uses Code_RechtsgrundlageHalterauskunft::setListURI()
     * @uses Code_RechtsgrundlageHalterauskunft::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_RechtsgrundlageHalterauskunft
     */
