...
/**
 * This class stands for Code.Reservierungsmerkmal StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Reservierungsmerkmal extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Reservierungsmerkmal
     * @uses Code_Reservierungsmerkmal::setCode()
     * @uses Code_Reservierungsmerkmal::setName()
     * @uses Code_Reservierungsmerkmal::setListURI()
     * @uses Code_Reservierungsmerkmal::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Reservierungsmerkmal
     */
