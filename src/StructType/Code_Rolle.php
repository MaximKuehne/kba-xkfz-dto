...
/**
 * This class stands for Code.Rolle StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Rolle extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Rolle
     * @uses Code_Rolle::setCode()
     * @uses Code_Rolle::setName()
     * @uses Code_Rolle::setListURI()
     * @uses Code_Rolle::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Rolle
     */
