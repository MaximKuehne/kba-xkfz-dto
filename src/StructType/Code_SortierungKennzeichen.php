...
/**
 * This class stands for Code.SortierungKennzeichen StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_SortierungKennzeichen extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.SortierungKennzeichen
     * @uses Code_SortierungKennzeichen::setCode()
     * @uses Code_SortierungKennzeichen::setName()
     * @uses Code_SortierungKennzeichen::setListURI()
     * @uses Code_SortierungKennzeichen::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_SortierungKennzeichen
     */
