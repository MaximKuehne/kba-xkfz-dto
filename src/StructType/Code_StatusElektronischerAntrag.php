...
/**
 * This class stands for Code.StatusElektronischerAntrag StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_StatusElektronischerAntrag extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.StatusElektronischerAntrag
     * @uses Code_StatusElektronischerAntrag::setCode()
     * @uses Code_StatusElektronischerAntrag::setName()
     * @uses Code_StatusElektronischerAntrag::setListURI()
     * @uses Code_StatusElektronischerAntrag::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_StatusElektronischerAntrag
     */
