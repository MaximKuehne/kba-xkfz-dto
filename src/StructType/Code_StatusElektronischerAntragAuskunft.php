...
/**
 * This class stands for Code.StatusElektronischerAntragAuskunft StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_StatusElektronischerAntragAuskunft extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.StatusElektronischerAntragAuskunft
     * @uses Code_StatusElektronischerAntragAuskunft::setCode()
     * @uses Code_StatusElektronischerAntragAuskunft::setName()
     * @uses Code_StatusElektronischerAntragAuskunft::setListURI()
     * @uses Code_StatusElektronischerAntragAuskunft::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_StatusElektronischerAntragAuskunft
     */
