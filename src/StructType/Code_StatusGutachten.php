...
/**
 * This class stands for Code.StatusGutachten StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_StatusGutachten extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.StatusGutachten
     * @uses Code_StatusGutachten::setCode()
     * @uses Code_StatusGutachten::setName()
     * @uses Code_StatusGutachten::setListURI()
     * @uses Code_StatusGutachten::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_StatusGutachten
     */
