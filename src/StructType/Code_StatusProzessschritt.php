...
/**
 * This class stands for Code.StatusProzessschritt StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_StatusProzessschritt extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.StatusProzessschritt
     * @uses Code_StatusProzessschritt::setCode()
     * @uses Code_StatusProzessschritt::setName()
     * @uses Code_StatusProzessschritt::setListURI()
     * @uses Code_StatusProzessschritt::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_StatusProzessschritt
     */
