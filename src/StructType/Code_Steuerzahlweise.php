...
/**
 * This class stands for Code.Steuerzahlweise StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Steuerzahlweise extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Steuerzahlweise
     * @uses Code_Steuerzahlweise::setCode()
     * @uses Code_Steuerzahlweise::setName()
     * @uses Code_Steuerzahlweise::setListURI()
     * @uses Code_Steuerzahlweise::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Steuerzahlweise
     */
