...
/**
 * This class stands for Code.SucheinschraenkungKennzeichen StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_SucheinschraenkungKennzeichen extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.SucheinschraenkungKennzeichen
     * @uses Code_SucheinschraenkungKennzeichen::setCode()
     * @uses Code_SucheinschraenkungKennzeichen::setName()
     * @uses Code_SucheinschraenkungKennzeichen::setListURI()
     * @uses Code_SucheinschraenkungKennzeichen::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_SucheinschraenkungKennzeichen
     */
