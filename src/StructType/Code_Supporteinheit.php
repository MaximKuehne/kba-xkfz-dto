...
/**
 * This class stands for Code.Supporteinheit StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Supporteinheit extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Supporteinheit
     * @uses Code_Supporteinheit::setCode()
     * @uses Code_Supporteinheit::setName()
     * @uses Code_Supporteinheit::setListURI()
     * @uses Code_Supporteinheit::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Supporteinheit
     */
