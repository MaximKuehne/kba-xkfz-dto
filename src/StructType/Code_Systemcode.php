...
/**
 * This class stands for Code.Systemcode StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Systemcode extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Systemcode
     * @uses Code_Systemcode::setCode()
     * @uses Code_Systemcode::setName()
     * @uses Code_Systemcode::setListURI()
     * @uses Code_Systemcode::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Systemcode
     */
