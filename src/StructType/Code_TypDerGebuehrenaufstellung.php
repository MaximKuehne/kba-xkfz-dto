...
/**
 * This class stands for Code.TypDerGebuehrenaufstellung StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_TypDerGebuehrenaufstellung extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.TypDerGebuehrenaufstellung
     * @uses Code_TypDerGebuehrenaufstellung::setCode()
     * @uses Code_TypDerGebuehrenaufstellung::setName()
     * @uses Code_TypDerGebuehrenaufstellung::setListURI()
     * @uses Code_TypDerGebuehrenaufstellung::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_TypDerGebuehrenaufstellung
     */
