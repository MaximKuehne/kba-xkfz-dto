...
/**
 * This class stands for Code.TypDerReferenzdatei StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_TypDerReferenzdatei extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.TypDerReferenzdatei
     * @uses Code_TypDerReferenzdatei::setCode()
     * @uses Code_TypDerReferenzdatei::setName()
     * @uses Code_TypDerReferenzdatei::setListURI()
     * @uses Code_TypDerReferenzdatei::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_TypDerReferenzdatei
     */
