...
/**
 * This class stands for Code.TypDerUntersuchung StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_TypDerUntersuchung extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.TypDerUntersuchung
     * @uses Code_TypDerUntersuchung::setCode()
     * @uses Code_TypDerUntersuchung::setName()
     * @uses Code_TypDerUntersuchung::setListURI()
     * @uses Code_TypDerUntersuchung::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_TypDerUntersuchung
     */
