...
/**
 * This class stands for Code.TypDesDokuments StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_TypDesDokuments extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.TypDesDokuments
     * @uses Code_TypDesDokuments::setCode()
     * @uses Code_TypDesDokuments::setName()
     * @uses Code_TypDesDokuments::setListURI()
     * @uses Code_TypDesDokuments::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_TypDesDokuments
     */
