...
/**
 * This class stands for Code.TypDesIdentifikationsdokuments StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_TypDesIdentifikationsdokuments extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.TypDesIdentifikationsdokuments
     * @uses Code_TypDesIdentifikationsdokuments::setCode()
     * @uses Code_TypDesIdentifikationsdokuments::setName()
     * @uses Code_TypDesIdentifikationsdokuments::setListURI()
     * @uses Code_TypDesIdentifikationsdokuments::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_TypDesIdentifikationsdokuments
     */
