...
/**
 * This class stands for Code.TypDesKennzeichens StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_TypDesKennzeichens extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.TypDesKennzeichens
     * @uses Code_TypDesKennzeichens::setCode()
     * @uses Code_TypDesKennzeichens::setName()
     * @uses Code_TypDesKennzeichens::setListURI()
     * @uses Code_TypDesKennzeichens::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_TypDesKennzeichens
     */
