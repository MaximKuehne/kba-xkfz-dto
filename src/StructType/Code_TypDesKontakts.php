...
/**
 * This class stands for Code.TypDesKontakts StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_TypDesKontakts extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.TypDesKontakts
     * @uses Code_TypDesKontakts::setCode()
     * @uses Code_TypDesKontakts::setName()
     * @uses Code_TypDesKontakts::setListURI()
     * @uses Code_TypDesKontakts::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_TypDesKontakts
     */
