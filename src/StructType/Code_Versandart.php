...
/**
 * This class stands for Code.Versandart StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Versandart extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Versandart
     * @uses Code_Versandart::setCode()
     * @uses Code_Versandart::setName()
     * @uses Code_Versandart::setListURI()
     * @uses Code_Versandart::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Versandart
     */
