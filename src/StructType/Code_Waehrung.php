...
/**
 * This class stands for Code.Waehrung StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Code_Waehrung extends AbstractStructBase
{
    /**
     * The code
     * @var string|null
    ...
    /**
     * Constructor method for Code.Waehrung
     * @uses Code_Waehrung::setCode()
     * @uses Code_Waehrung::setName()
     * @uses Code_Waehrung::setListURI()
     * @uses Code_Waehrung::setListVersionID()
     * @param string $code
     * @param string $name
     ...
     * Set code value
     * @param string $code
     * @return \THAG\XKfz\StructType\Code_Waehrung
     */
