...
/**
 * This class stands for Empfangsbevollmaechtigter StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Empfangsbevollmaechtigter extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Empfangsbevollmaechtigter
     * @uses Empfangsbevollmaechtigter::setDatumEmpfangsbevollmaechtigung()
     * @uses Empfangsbevollmaechtigter::setPerson()
     * @uses Empfangsbevollmaechtigter::setAnschrift()
     ...
     * @param string $datumEmpfangsbevollmaechtigung
     * @return \THAG\XKfz\StructType\Empfangsbevollmaechtigter
     */
