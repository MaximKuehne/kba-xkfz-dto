...
/**
 * This class stands for FahrzeugbeschreibungZSTyp StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class FahrzeugbeschreibungZSTyp extends AbstractStructBase
{
    /**
     * The ArtGenehmigung
     * @var string|null
    ...
    /**
     * Constructor method for FahrzeugbeschreibungZSTyp
     * @uses FahrzeugbeschreibungZSTyp::setArtGenehmigung()
     * @uses FahrzeugbeschreibungZSTyp::setSchluesselFahrzeugklasse()
     * @uses FahrzeugbeschreibungZSTyp::setSchluesselAufbau()
     * @uses FahrzeugbeschreibungZSTyp::setSchluesselEmissionsklasse()
     * @uses FahrzeugbeschreibungZSTyp::setTextEmissionsklasseEGTypgenehmigung()
     * @uses FahrzeugbeschreibungZSTyp::setSchluesselKraftstoff()
     * @uses FahrzeugbeschreibungZSTyp::setKombinierterCO2Wert()
     * @uses FahrzeugbeschreibungZSTyp::setKombinierterCo2WertWltp()
     * @uses FahrzeugbeschreibungZSTyp::setHoechstgeschwindigkeit()
     * @uses FahrzeugbeschreibungZSTyp::setNennleistungKW()
     * @uses FahrzeugbeschreibungZSTyp::setNennleistungUmdrehung()
     * @uses FahrzeugbeschreibungZSTyp::setHubraum()
     * @uses FahrzeugbeschreibungZSTyp::setLeistungsgewicht()
     * @uses FahrzeugbeschreibungZSTyp::setNutzlast()
     * @uses FahrzeugbeschreibungZSTyp::setRauminhalt()
     * @uses FahrzeugbeschreibungZSTyp::setAnzahlStehplaetze()
     * @uses FahrzeugbeschreibungZSTyp::setAnzahlSitzplaetze()
     * @uses FahrzeugbeschreibungZSTyp::setMasseFahrbereitMin()
     * @uses FahrzeugbeschreibungZSTyp::setMasseFahrbereitMax()
     * @uses FahrzeugbeschreibungZSTyp::setTechnischZulaessigeGesamtmasse()
     * @uses FahrzeugbeschreibungZSTyp::setTechnischZulaessigeAchslastAchse1()
     * @uses FahrzeugbeschreibungZSTyp::setTechnischZulaessigeAchslastAchse2()
     * @uses FahrzeugbeschreibungZSTyp::setTechnischZulaessigeAchslastAchse3()
     * @uses FahrzeugbeschreibungZSTyp::setStuetzlast()
     * @uses FahrzeugbeschreibungZSTyp::setAnhaengelastGebremst()
     * @uses FahrzeugbeschreibungZSTyp::setAnhaengelastUngebremst()
     * @uses FahrzeugbeschreibungZSTyp::setAnzahlAchsen()
     * @uses FahrzeugbeschreibungZSTyp::setAnzahlAntriebsachsen()
     * @uses FahrzeugbeschreibungZSTyp::setStandgeraeusch()
     * @uses FahrzeugbeschreibungZSTyp::setStandgeraeuschUmdrehung()
     * @uses FahrzeugbeschreibungZSTyp::setFahrgeraeusch()
     * @uses FahrzeugbeschreibungZSTyp::setBereifungAchse1()
     * @uses FahrzeugbeschreibungZSTyp::setBereifungAchse2()
     * @uses FahrzeugbeschreibungZSTyp::setBereifungAchse3()
     * @uses FahrzeugbeschreibungZSTyp::setLaengeMax()
     * @uses FahrzeugbeschreibungZSTyp::setLaengeMin()
     * @uses FahrzeugbeschreibungZSTyp::setBreiteMax()
     * @uses FahrzeugbeschreibungZSTyp::setBreiteMin()
     * @uses FahrzeugbeschreibungZSTyp::setHoeheMax()
     * @uses FahrzeugbeschreibungZSTyp::setHoeheMin()
     * @uses FahrzeugbeschreibungZSTyp::setBeiblatt()
     * @uses FahrzeugbeschreibungZSTyp::setBemerkungenAusnahmen()
     * @uses FahrzeugbeschreibungZSTyp::setTextFahrzeugklasse()
     * @uses FahrzeugbeschreibungZSTyp::setTextKraftstoff()
     * @uses FahrzeugbeschreibungZSTyp::setTextAufbau()
     * @uses FahrzeugbeschreibungZSTyp::setTextEmissionsklasse()
     * @uses FahrzeugbeschreibungZSTyp::setSteuerEmissionsrelevanteDaten()
     * @uses FahrzeugbeschreibungZSTyp::setGenehmigungsnummerPMS()
     * @uses FahrzeugbeschreibungZSTyp::setDatumNachruestung()
     * @uses FahrzeugbeschreibungZSTyp::setDatumErstzulassung()
     ...
     * @param string $artGenehmigung
     * @return \THAG\XKfz\StructType\FahrzeugbeschreibungZSTyp
     */
