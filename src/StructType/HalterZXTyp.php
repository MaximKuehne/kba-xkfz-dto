...
/**
 * This class stands for HalterZXTyp StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class HalterZXTyp extends AbstractStructBase
{
    /**
     * The Person
    ...
    /**
     * Constructor method for HalterZXTyp
     * @uses HalterZXTyp::setPerson()
     * @uses HalterZXTyp::setAnschrift()
     ...
     * Set Person value
     * @param \THAG\XKfz\StructType\Person $person
     * @return \THAG\XKfz\StructType\HalterZXTyp
     */
