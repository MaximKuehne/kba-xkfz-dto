...
/**
 * This class stands for SicherheitscodesGemeinsamerKennzeichenteil StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class SicherheitscodesGemeinsamerKennzeichenteil extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for SicherheitscodesGemeinsamerKennzeichenteil
     * @uses SicherheitscodesGemeinsamerKennzeichenteil::setSicherheitscodeKennz1()
     * @uses SicherheitscodesGemeinsamerKennzeichenteil::setSicherheitscodeKennz2()
     ...
     * @param string $sicherheitscodeKennz1
     * @return \THAG\XKfz\StructType\SicherheitscodesGemeinsamerKennzeichenteil
     */
