...
/**
 * This class stands for Type.AufkleberZulBeschTeil2Referenzdatensatz StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Type_AufkleberZulBeschTeil2Referenzdatensatz extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Type.AufkleberZulBeschTeil2Referenzdatensatz
     * @uses Type_AufkleberZulBeschTeil2Referenzdatensatz::setDruckstuecknummer()
     * @uses Type_AufkleberZulBeschTeil2Referenzdatensatz::setSicherheitscode()
     * @uses Type_AufkleberZulBeschTeil2Referenzdatensatz::setVerpackung()
     * @uses Type_AufkleberZulBeschTeil2Referenzdatensatz::setListeReferenz()
     ...
     * @param string $druckstuecknummer
     * @return \THAG\XKfz\StructType\Type_AufkleberZulBeschTeil2Referenzdatensatz
     */
