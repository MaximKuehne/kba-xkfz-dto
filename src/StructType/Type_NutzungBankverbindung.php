...
class Type_NutzungBankverbindung extends AbstractStructBase
{
    /**
     * The code
     * @var \THAG\XKfz\StructType\Code_NutzungBankverbindung|null
     */
     ...
     * @param \THAG\XKfz\StructType\Code_NutzungBankverbindung $code
     * @param string $zusatz
     */
    ...
    /**
     * Get code value
     * @return \THAG\XKfz\StructType\Code_NutzungBankverbindung|null
     */
     ...
     * Set code value
     * @param \THAG\XKfz\StructType\Code_NutzungBankverbindung $code
     * @return \THAG\XKfz\StructType\Type_NutzungBankverbindung
     */
