...
/**
 * This class stands for Type.PersonMitAnschrift StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Type_PersonMitAnschrift extends AbstractStructBase
{
    /**
     * The Person
    ...
    /**
     * Constructor method for Type.PersonMitAnschrift
     * @uses Type_PersonMitAnschrift::setPerson()
     * @uses Type_PersonMitAnschrift::setAnschrift()
     ...
     * Set Person value
     * @param \THAG\XKfz\StructType\Person $person
     * @return \THAG\XKfz\StructType\Type_PersonMitAnschrift
     */
