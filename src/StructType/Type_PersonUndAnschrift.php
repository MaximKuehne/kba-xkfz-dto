...
/**
 * This class stands for Type.PersonUndAnschrift StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Type_PersonUndAnschrift extends AbstractStructBase
{
    /**
     * The Person
    ...
    /**
     * Constructor method for Type.PersonUndAnschrift
     * @uses Type_PersonUndAnschrift::setPerson()
     * @uses Type_PersonUndAnschrift::setAnschrift()
     ...
     * Set Person value
     * @param \THAG\XKfz\StructType\Person $person
     * @return \THAG\XKfz\StructType\Type_PersonUndAnschrift
     */
