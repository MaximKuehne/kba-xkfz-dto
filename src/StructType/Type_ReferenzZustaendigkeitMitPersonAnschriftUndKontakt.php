...
/**
 * This class stands for Type.ReferenzZustaendigkeitMitPersonAnschriftUndKontakt
 * StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
...
class Type_ReferenzZustaendigkeitMitPersonAnschriftUndKontakt extends AbstractStructBase
{
    /**
     * The person
    ...
    /**
     * Constructor method for Type.ReferenzZustaendigkeitMitPersonAnschriftUndKontakt
     * @uses Type_ReferenzZustaendigkeitMitPersonAnschriftUndKontakt::setPerson()
     * @uses Type_ReferenzZustaendigkeitMitPersonAnschriftUndKontakt::setKontakte()
     ...
     * Set person value
     * @param \THAG\XKfz\StructType\Type_PersonUndAnschrift $person
     * @return \THAG\XKfz\StructType\Type_ReferenzZustaendigkeitMitPersonAnschriftUndKontakt
     */
