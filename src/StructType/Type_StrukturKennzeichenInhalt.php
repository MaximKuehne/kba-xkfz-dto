...
class Type_StrukturKennzeichenInhalt extends AbstractStructBase
{
     ...
     * @param int $laengeUnterscheidungszeichen
     * @param int $laengeErkennungszeichen
     * @param int $laengeErkennungsnummer
     */
     ...
     * @param int $laengeUnterscheidungszeichen
     * @return \THAG\XKfz\StructType\Type_StrukturKennzeichenInhalt
     */
