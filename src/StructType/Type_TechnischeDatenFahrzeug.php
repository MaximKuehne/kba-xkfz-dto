...
/**
 * This class stands for Type.TechnischeDatenFahrzeug StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Type_TechnischeDatenFahrzeug extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Type.TechnischeDatenFahrzeug
     * @uses Type_TechnischeDatenFahrzeug::setSchluesselHersteller()
     * @uses Type_TechnischeDatenFahrzeug::setFahrzeugidentifizierungsnummer()
     * @uses Type_TechnischeDatenFahrzeug::setPruefzifferFahrzeugidentifizierungsnummer()
     * @uses Type_TechnischeDatenFahrzeug::setSchluesselTyp()
     * @uses Type_TechnischeDatenFahrzeug::setSchluesselVarianteVersion()
     * @uses Type_TechnischeDatenFahrzeug::setPruefzifferTypVarianteVersion()
     * @uses Type_TechnischeDatenFahrzeug::setGenehmigungsnummer()
     * @uses Type_TechnischeDatenFahrzeug::setDatumGenehmigung()
     * @uses Type_TechnischeDatenFahrzeug::setTextHersteller()
     * @uses Type_TechnischeDatenFahrzeug::setTextMarke()
     * @uses Type_TechnischeDatenFahrzeug::setTextHandelsbezeichnung()
     * @uses Type_TechnischeDatenFahrzeug::setTextTyp()
     * @uses Type_TechnischeDatenFahrzeug::setTextVariante()
     * @uses Type_TechnischeDatenFahrzeug::setTextVersion()
     * @uses Type_TechnischeDatenFahrzeug::setSchluesselGrundfarbe()
     * @uses Type_TechnischeDatenFahrzeug::setSchluesselZweitfarbe()
     ...
     * @param string $schluesselHersteller
     * @return \THAG\XKfz\StructType\Type_TechnischeDatenFahrzeug
     */
