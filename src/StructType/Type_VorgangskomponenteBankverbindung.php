...
/**
 * This class stands for Type.VorgangskomponenteBankverbindung StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Type_VorgangskomponenteBankverbindung extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Type.VorgangskomponenteBankverbindung
     * @uses Type_VorgangskomponenteBankverbindung::setNutzungBankverbindung()
     * @uses Type_VorgangskomponenteBankverbindung::setBankverbindungNational()
     * @uses Type_VorgangskomponenteBankverbindung::setBankverbindungInternational()
     * @uses Type_VorgangskomponenteBankverbindung::setNameBankverbindung()
     * @uses Type_VorgangskomponenteBankverbindung::setKontoinhaber()
     * @uses Type_VorgangskomponenteBankverbindung::setMerkmalEinzugsermaechtigungErteilt()
     ...
     * @param \THAG\XKfz\StructType\Type_NutzungBankverbindung $nutzungBankverbindung
     * @return \THAG\XKfz\StructType\Type_VorgangskomponenteBankverbindung
     */
