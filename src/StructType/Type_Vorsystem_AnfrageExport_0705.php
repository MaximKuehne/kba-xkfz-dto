...
/**
 * This class stands for Type.Vorsystem.AnfrageExport.0705 StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class Type_Vorsystem_AnfrageExport_0705 extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Type.Vorsystem.AnfrageExport.0705
     * @uses Type_Vorsystem_AnfrageExport_0705::setReferenzElektronischerAntrag()
     * @uses Type_Vorsystem_AnfrageExport_0705::setDokument()
     ...
     * @param \THAG\XKfz\StructType\ReferenzElektronischerAntrag $referenzElektronischerAntrag
     * @return \THAG\XKfz\StructType\Type_Vorsystem_AnfrageExport_0705
     */
