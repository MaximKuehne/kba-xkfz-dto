...
/**
 * This class stands for VersicherungsdatenZWTyp StructType
 * @subpackage Structs
 * @date 2024-05-13
 * @codeVersion 5.9
 */
#[\AllowDynamicProperties]
class VersicherungsdatenZWTyp extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for VersicherungsdatenZWTyp
     * @uses VersicherungsdatenZWTyp::setDatumVersicherungsbeginn()
     * @uses VersicherungsdatenZWTyp::setVersicherungsunternehmensnummer()
     * @uses VersicherungsdatenZWTyp::setVersicherungsscheinnummer()
     * @uses VersicherungsdatenZWTyp::setVersicherungsbestaetigungsnummer()
     * @uses VersicherungsdatenZWTyp::setMerkmalBefreiungVersicherungspflicht()
     * @uses VersicherungsdatenZWTyp::setDatumEndeVersicherungsschutz()
     * @uses VersicherungsdatenZWTyp::setVerkehrsjahr()
     * @uses VersicherungsdatenZWTyp::setDatumNichtbestehenVersicherung()
     * @uses VersicherungsdatenZWTyp::setDatumEingangFehlenderVersicherungsschutz()
     * @uses VersicherungsdatenZWTyp::setMerkmalMassnahmeZulassungsbehoerdeEingeleitet()
     * @uses VersicherungsdatenZWTyp::setDatumEingangVersicherungsbestaetigung()
     * @uses VersicherungsdatenZWTyp::setDatumAnlageVersicherung()
     ...
     * @param string $datumVersicherungsbeginn
     * @return \THAG\XKfz\StructType\VersicherungsdatenZWTyp
     */
