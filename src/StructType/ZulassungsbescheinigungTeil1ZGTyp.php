...
class ZulassungsbescheinigungTeil1ZGTyp extends AbstractStructBase
{
    /**
     ...
     * @uses ZulassungsbescheinigungTeil1ZGTyp::setDatumRueckgabeEinziehung()
     * @uses ZulassungsbescheinigungTeil1ZGTyp::setHinweisAusstellungZweitschrift()
     * @uses ZulassungsbescheinigungTeil1ZGTyp::setDatumAusstellungZweitschrift()
     * @uses ZulassungsbescheinigungTeil1ZGTyp::setZeitpunktEintragungAusserbetriebsetzungZulBeschTeil1()
     * @uses ZulassungsbescheinigungTeil1ZGTyp::setNaechsteHauptuntersuchung()
